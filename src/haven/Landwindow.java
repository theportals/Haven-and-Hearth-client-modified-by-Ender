...
public class Landwindow extends Window{
	...
	static
	{
		Widget.addtype("ui/land2", new WidgetFactory() {
			public Widget create(Coord coord, Widget widget, Object aobj[])
			{
				...
				return new Landwindow(coord, widget, coord1, coord2);
			}
		});
	}
	...
	private void updflags()
	{
		...
		for (Landwindow.PermBox localPermBox : this.perms) {
	...
	private class PermBox extends CheckBox{
		...
		{
			int i = 0;
			for (PermBox localPermBox : Landwindow.this.perms) {
				if (localPermBox.a) {
					i |= localPermBox.fl;
				}
			}
			Landwindow.this.wdgmsg("shared", new Object[] { Integer.valueOf(Landwindow.this.group.group), Integer.valueOf(i) });
		}
	}
	
	public Landwindow(Coord paramCoord1, Widget paramWidget, Coord paramCoord2, Coord paramCoord3){
		...
		this.perms[0] = new Landwindow.PermBox(new Coord(0, 155), this, "Trespassing", 1);
		this.perms[1] = new Landwindow.PermBox(new Coord(80, 155), this, "Theft", 2);
		this.perms[2] = new Landwindow.PermBox(new Coord(160, 155), this, "Vandalism", 4);
